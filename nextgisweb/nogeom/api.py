...
def setup_pyramid(comp, config):
    config.add_route(
        ...
        '/api/resource/{id:uint}/nogeom_inspect/',
        factory=resource_factory
    ).get(nogeom_inspect_connection, context=NogeomConnection)

    config.add_route(
        'nogeom.connection.nogeom_inspect.table',
        '/api/resource/{id:uint}/nogeom_inspect/{table_name:str}/',
        factory=resource_factory
    ).get(nogeom_inspect_table, context=NogeomConnection)
