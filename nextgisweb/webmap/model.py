...
class WebMap(Base, Resource):
    ...
    extent_const_left = db.Column(db.Float, default=None)
    extent_const_right = db.Column(db.Float, default=None)
    extent_const_bottom = db.Column(db.Float, default=None)
    extent_const_top = db.Column(db.Float, default=None)
